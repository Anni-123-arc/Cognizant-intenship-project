...
// MongoDB connection
const uri = "mongodb+srv://anni9890:anni9890@cluster0.pecfjcx.mongodb.net/test?retryWrites=true&w=majority"; // replace with your URI
...
const insertOrders = async () => {
  try {
    await ViewOrder.insertMany(orders);
